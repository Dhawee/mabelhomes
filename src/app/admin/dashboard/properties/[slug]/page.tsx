...
import type { Property, PropertyEnquiry } from "@/types/admin";
...
export default function PropertyDetailsPage({ params }: Props) {
  ...
  const handleDuplicate = async () => {
    try {
      ...
      router.push(`/admin/dashboard/properties/${duplicated.slug}`);
    } catch (err: any) {
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between flex-wrap gap-4">
        <div className="flex items-center gap-3">
          <Link href="/admin/dashboard/properties" className="btn btn-outline p-2">
            <ArrowLeft size={16} />
          </Link>
          <div>
        ...
        <div className="flex items-center gap-2 flex-wrap">
          {property.is_deleted ? (
            ...
            <>
              ...
              <Link href={`/admin/dashboard/properties/${slug}/edit`} className="btn btn-primary gap-2">
                <Edit size={14} /> Edit
              </Link>
            ...
            <tbody>
              {enquiries.map((enq) => (
                <tr key={enq.id}>
                  ...
                  <td>
                    <Link href={`/admin/dashboard/property-enquiries/${enq.id}`} className="btn btn-outline py-1 px-3 text-xs">
                      View Reply
                    </Link>
                  </td>
                </tr>
