      ...
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div>
          <h1 className="text-2xl font-extrabold text-gray-900 flex items-center gap-2">
            <Home size={22} className="text-navy" style={{ color: "var(--color-navy)" }} />
            Properties
          </h1>
        ...
        <div className="flex items-center gap-2">
          ...
          <Link href="/dashboard/properties/new" className="btn btn-primary gap-2 py-2 text-sm">
                    ...
                    <tr key={prop.id}>
                      <td>
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <div className="font-medium text-gray-900 max-w-[200px] truncate text-sm">
                              {prop.title}
                            </div>
                      ...
                      <td>
                        <div className="flex gap-2">
                          ...
                          {prop.is_deleted ? (
                            ...
                            <Link
                              href={`/dashboard/properties/${prop.slug}/edit`}
